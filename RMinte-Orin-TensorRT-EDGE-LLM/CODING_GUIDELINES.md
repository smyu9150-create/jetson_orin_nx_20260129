...
# TensorRT-Edge-LLM Coding Guidelines

## C++ Coding Guidelines

The TensorRT-Edge-LLM C++ Coding Guidelines are mainly derived from the [Google C++ Style Guide](https://google.github.io/styleguide/cppguide.html)
...
#### Python Standard
1. The code developed for TensorRT-Edge-LLM should conform to Python 3.8+.
...
1. All TensorRT-Edge-LLM Open Source Software code should contain an NVIDIA copyright header that includes the current year.  The following block of text should be prepended to the top of all files.  This includes .cpp, .h, .cu, .py, and any other source files which are compiled or interpreted.
```cpp
/*
